...
def Jokes():
    jks = ["Automatic simply means that you cannot repair it yourself.",
...
"Anyone in good enough condition to run three miles a day is in goo enough condition not to have to.",
...
"Economics is the only calling in which one can have a lifetime reputation as an expert without ever once being right.Education confers understanding, knowledge, and competence; schools confer degrees.",
...
"In some countries, Chaucer and Dante are the classics. In thiscountry, it's a soft drink.",
...
"basic desire to choke the living shit out of some asshole who desperately needs it.",
...
"The only people to profit from the mistakes of others arebiographers.",
"The only perfect science is hindsight.",
"The only thing worse than a male chauvinist pig is the female version.",
"The only things in history that are inevitable are those that havealready happened.",
"The opera ain't over 'til the fat lady sings.",
"The opulence of the front office decor varies inversely with thefundamental solvency of the firm.",
"The organization of any bureaucracy is very much like a septictank....The really big chunks always rise to the top.",
"The person who buys the most raffle tickets has the least chance ofwinning.",
"The person who marries for money generally ends up earning it.",
"The person who snores the loudest will fall asleep first.",
"The price of total freedom is total anarchy. The price of totalsecurity is total enslavement.",
